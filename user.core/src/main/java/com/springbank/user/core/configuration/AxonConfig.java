...
//    @Bean
//    public EmbeddedEventStore eventStore(EventStorageEngine storageEngine, Configurer configurer) {
//        return EmbeddedEventStore.builder()
//                .storageEngine(storageEngine)
////                .messageMonitor(configuration.messageMonitor(EventStore.class, "eventStore"))
//                .messageMonitor(configurer.configureMessageMonitor(EventStore.class, "eventStore"))
//                .build();
//    }
}
